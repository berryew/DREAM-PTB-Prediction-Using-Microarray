...
As a team participant of [DREAM Preterm Birth Prediction Challenge, Transcriptomics](https://www.synapse.org/#!Synapse:syn18380862/wiki/590485) and a course project as well, we predicted Control vs. sTPD and Control vs. RRPOM using microarray data by combining differential expression, co-expression, survival analysis and classification. 
